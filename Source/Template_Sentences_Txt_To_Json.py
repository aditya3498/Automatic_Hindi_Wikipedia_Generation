...
template_sentences_single_pair = ['{{Scientist}} एक प्रसिद्ध {{व्यवसाय}} {{alivestatus/wgop}}',
	...
	'{{Scientist}} को {{इससे अलग}} से भ्रमित नहीं करना चाहिए',
...
template_sentences_two_pairs = ['{{Scientist}} एक प्रसिद्ध {{व्यवसाय}} {{alivestatus/wgop}} जिनका जन्म {{जन्म तिथि}} को हुआ {{alivestatus}}',
