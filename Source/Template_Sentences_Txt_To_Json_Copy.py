...
template_sentences_single_pair = ['वह एक प्रसिद्ध {{व्यवसाय}} {alivestatus/wgop} |',
	...
	'वह निम्नलिखित छात्र - {{डॉक्टरेट छात्र}} {के/की} डॉक्टरल एडवाइजर्स {alivestatus/wgop} |',
...
template_sentences_two_pairs = ['{{Scientist}} को {{इससे अलग}} से भ्रमित नहीं करना चाहिए',
	...
	'{{Scientist}} को {{Reason}} के लिए {{पुरस्कार प्राप्त}} से सम्मानित किया गया {alivestatus}',
	
	'उनकी मातृभाषा {{मातृ भाषा}} {alivestatus/wgok} परन्तु उनकी बोली या लेखी भाषा {{बोली या लेखी भाषा}} {alivestatus/wgok}',

	'{{Scientist}} के शिक्षक {{के छात्र }} {alivestatus/wgok}, डॉक्टरेट एडवाइजर् {{डॉक्टरेट सलाहकार}} {alivestatus/wgok} और वह स्वयं निम्नलिखित {{डॉक्टरेट छात्र}} {के/की} डॉक्टरेट एडवाइजर् {alivestatus/wgop}',
	'{{Scientist}} के डॉक्टरेट एडवाइजर् {{डॉक्टरेट सलाहकार}} {alivestatus/wgok} और वह स्वयं निम्नलिखित {{डॉक्टरेट छात्र}} {के/की} डॉक्टरेट एडवाइजर् होने के साथ साथ {{छात्र}} के शिक्षक भी {alivestatus/wgop}',
	...
	'{{Scientist}} के शिक्षक {{के छात्र }} {alivestatus/wgok} और वह स्वयं निम्नलिखित {{डॉक्टरेट छात्र}} {के/की} डॉक्टरेट एडवाइजर् होने के साथ साथ {{छात्र}} के शिक्षक भी {alivestatus/wgop}',
	...
	'{{Scientist}} {के/की} जीवन साथी {{जीवन साथी}} {alivestatus/wgop} और उनके {{बच्चों की संख्या}} बच्चे {alivestatus/wgok}',
	'{{Scientist}} {के/की} जीवन साथी {{जीवन साथी}} {alivestatus/wgop} और उनके बच्चों का नाम {{संतान}} {alivestatus}',
	'{{Scientist}} के {{बच्चों की संख्या}} बच्चे {alivestatus/wgok} जिनका नाम {{संतान}} {alivestatus}'
]
...
template_sentences_three_pairs = ['{{Scientist}} एक प्रसिद्ध {{व्यवसाय}} {alivestatus/wgop} जिनका जन्म {{जन्म तिथि}} को {{जन्म स्थान}} देश में हुआ {alivestatus}',
	...
	'{{Scientist}} को {{Reason}} के लिए {{पुरस्कार प्राप्त}} से सम्मानित किया गया {alivestatus} और उन्हें {{नामांकित किया गया}} के लिए नामांकित भी किया गया {alivestatus}',
