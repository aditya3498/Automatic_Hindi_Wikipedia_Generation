...
template_sentences_single_pair = ['{{Scientist}} एक प्रसिद्ध {{व्यवसाय}} {alivestatus/wgop}',
...
template_sentences_two_pairs = ['{{Scientist}} को {{इससे अलग}} से भ्रमित नहीं करना चाहिए',
	...
	'{{Scientist}} को उनके {{Reason}} के काम के लिए {{पुरस्कार प्राप्त}} से सम्मानित किया गया और उन्हें {{नामांकित किया गया}} के लिए नामांकित भी किया गया {alivestatus}',
